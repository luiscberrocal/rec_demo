...
from .views import account_list_view, account_create_view, account_update_view, account_delete_view, \
    account_detail_view, payment_plan_update_view
...
urlpatterns = [
    ...
    path(r'payment-plan/update/<int:pk>/', payment_plan_update_view, name='update-payment-plan'),
