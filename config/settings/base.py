...
MIGRATION_MODULES = {"sites": "rec_demo.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "rec_demo.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Daniel Roy Greenfeld""", "luis.berrocal.1942@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "rec_demo.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "rec_demo.users.adapters.SocialAccountAdapter"
